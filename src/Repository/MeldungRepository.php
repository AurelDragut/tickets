...
/**
 * @extends ServiceEntityRepository<Meldung>
 *
...
class MeldungRepository extends ServiceEntityRepository
{
    ...
    public function save(Meldung $entity, bool $flush = false): void
    {
    ...
    public function remove(Meldung $entity, bool $flush = false): void
    {
