...
class ArchivierterAuftragCrudController extends AbstractCrudController
{
    ...
    public function configureFields(string $pageName): iterable
    {
        ...
        return [
            NumberField::new('id')->hideWhenUpdating()->hideOnDetail(),
            ...
            CollectionField::new('AuftragStatuses', 'Chronik der Anfragestatus', array('mapped' => false))->hideOnIndex()->setDisabled()->allowAdd(false)->setColumns(12)
            ...
            BooleanField::new('sendEmail','Keine E-Mail senden')->setColumns(6)->hideOnIndex(),
            ...
            ImageField::new('Bild_1', 'Bild #1')->hideOnIndex()->setBasePath('images/tickets')->setUploadDir('public/images/tickets')->setColumns(2),
            ImageField::new('Bild_2', 'Bild #2')->hideOnIndex()->setBasePath('images/tickets')->setUploadDir('public/images/tickets')->setColumns(2),
            ImageField::new('Bild_3', 'Bild #3')->hideOnIndex()->setBasePath('images/tickets')->setUploadDir('public/images/tickets')->setColumns(2),
            ImageField::new('Bild_4', 'Bild #4')->hideOnIndex()->setBasePath('images/tickets')->setUploadDir('public/images/tickets')->setColumns(2),
            ImageField::new('Bild_5', 'Bild #5')->hideOnIndex()->setBasePath('images/tickets')->setUploadDir('public/images/tickets')->setColumns(2),
    ...
    public function configureCrud(Crud $crud): Crud
    {
        return $crud
            ...
            ->setPageTitle('index', 'Archivierte Auftr&auml;ge')
...
//            ->showEntityActionsAsDropdown()
    ...
    public function createIndexQueryBuilder(SearchDto $searchDto, EntityDto $entityDto, FieldCollection $fields, FilterCollection $filters): QueryBuilder
    {
        ...
        if ($this->isGranted('ROLE_ADMIN')) return $queryBuilder->andWhere('entity.isArchiviert = :archiviert')
            ->setParameter('archiviert', true);

        if ($this->isGranted('ROLE_MITARBEITER')) return $queryBuilder->andWhere('entity.Mitarbeiter = :user')->setParameter('user', $this->getUser());
        return $queryBuilder->andWhere('entity.Rechnung.kdnr = :user')->setParameter('user', $this->getUser()->getKdNr())->andWhere('entity.isArchiviert = :archiviert')
            ->setParameter('archiviert', true);
    }
